...
export default function VerifyIncidentModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-slate-900/70 backdrop-blur-sm text-slate-800 font-sans antialiased overflow-y-auto">
      ...
      <div className="relative w-full max-w-6xl h-[90vh] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-slate-200">
        ...
        <div className="flex-1 overflow-hidden flex flex-col lg:flex-row bg-slate-50/30">
          ...
          <aside className="w-full lg:w-[380px] shrink-0 bg-white p-5 flex flex-col justify-between overflow-y-auto space-y-5 border-l border-slate-100">
