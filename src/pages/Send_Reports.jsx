...
const InteractiveHoverButton = ({ children, onClick, className = "", ...props }) => {
  return (
    <button
      onClick={onClick}
      className={`group relative min-w-[120px] xl:min-w-[130px] cursor-pointer overflow-hidden rounded-lg bg-slate-900 dark:bg-slate-100 p-2 text-center text-xs font-semibold text-white dark:text-slate-900 transition-all duration-300 hover:bg-slate-800 dark:hover:bg-white border border-slate-800 dark:border-slate-200 shadow-sm ${className}`}
      {...props}
    >
      <div className="flex items-center justify-center gap-2">
        <div className="h-1.5 w-1.5 rounded-full bg-blue-500 transition-all duration-300 group-hover:scale-[100]" />
        <span className="inline-block transition-all duration-300 group-hover:translate-x-12 group-hover:opacity-0 relative z-10 whitespace-nowrap">
          {children}
        </span>
      </div>
      <div className="absolute top-0 z-10 flex h-full w-full translate-x-12 items-center justify-center gap-2 text-white dark:text-slate-900 opacity-0 transition-all duration-300 group-hover:-translate-x-3 group-hover:opacity-100">
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 p-4 sm:p-6 lg:p-8 xl:p-10 font-sans transition-all">
      <div className="w-full max-w-[1920px] mx-auto space-y-6">
        ...
        {activeTab === 'archived' ? (
          ...
          <>
            {/* Search & Toolbar Bar */}
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 bg-white dark:bg-slate-900 p-3.5 sm:p-4 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
            ...
            {loading ? (
              viewMode === 'grid' ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-4 3xl:grid-cols-5 gap-6">
                  {[...Array(8)].map((_, i) => (
                    <CardSkeleton key={i} />
                  ))}
                </div>
                      ...
                      {paginatedReports.map((report) => {
                        ...
                        return (
                          <div
                            ...
                            className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md transition-all flex flex-col overflow-hidden group"
                          >
                            ...
                            <div className="p-5 flex-1 flex flex-col space-y-4">
                              <div className="flex items-center justify-between gap-2">
                                <div className="flex items-center gap-1.5 overflow-hidden">
                                  ...
                                  <span className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider border shadow-xs transition-colors shrink-0 ${getIncidentBadgeStyle(report.incidentType)}`}>
                                ...
                                <div className="flex flex-col items-end text-[10px] text-slate-500 dark:text-slate-400 shrink-0">
                                  ...
                                  {dt.time && (
                                    <span className="flex items-center gap-1 font-normal text-slate-400 dark:text-slate-500">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-slate-500 dark:text-slate-400 flex items-start gap-1.5 mt-1.5 min-h-[32px]">
                              ...
                              <div className="mt-auto pt-4 border-t border-slate-100 dark:border-slate-800 space-y-2">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                  <Button
                                    ...
                                    className="inline-flex items-center justify-center gap-1.5 bg-emerald-700 hover:bg-emerald-800 text-white text-xs font-semibold shadow-sm"
                                  >
                                  ...
                                  <Button
                                    ...
                                    className="inline-flex items-center justify-center gap-1.5 bg-red-800 hover:bg-red-900 text-white text-xs font-semibold shadow-sm"
                                  >
