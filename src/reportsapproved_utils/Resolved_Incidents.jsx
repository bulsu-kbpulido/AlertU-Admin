...
export default function Resolved_Incidents({ onRestoreSuccess, onCountChange }) {
  ...
  // Aftermath details view dialog state
  ...
  // --- Trigger Aftermath Details View ---
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle className="flex items-center gap-2 text-slate-800 dark:text-slate-100">
              <FileText className="h-5 w-5 text-blue-600" /> Aftermath Details
            </AlertDialogTitle>
            <AlertDialogDescription asChild>
              <div className="space-y-3 text-left">
                ...
                <div className="p-3 rounded-lg bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-sm text-slate-700 dark:text-slate-300 whitespace-pre-wrap">
                  {detailsReport?.aftermathDetails?.trim()
                    ? detailsReport.aftermathDetails
                    : 'No aftermath details were recorded for this report.'}
                </div>
              </div>
            </AlertDialogDescription>
          </AlertDialogHeader>
