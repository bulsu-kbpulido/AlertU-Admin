...
const SCORE_COLORS = [// unused (score 0)
"#f43f5e", // rose-500
"#f43f5e", // orange-500
"#f97316", // amber-400
"#fbbf24", // emerald-500
...
const labelVariants = {
  enter: (direction) => ({ y: direction * 8, opacity: 0 }),
  center: { y: 0, opacity: 1 },
  exit: (direction) => ({ y: direction * -8, opacity: 0 }),
}
      ...
      {showMeter && (
        <div id={meterId} role="status" aria-live="polite">
          ...
          <div className="flex items-center gap-3" aria-hidden="true">
            ...
            <span
              className="relative inline-grid h-4 shrink-0 items-center justify-items-end overflow-hidden">
              ...
              <li
                ...
                <svg viewBox="0 0 16 16" className="h-3.5 w-3.5 shrink-0" aria-hidden="true">
                  <circle
                    ...
                    r="6.5"
                    strokeWidth="1.5"
                    className={cn("transition-colors duration-200", done
